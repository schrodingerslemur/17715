...
int main() {
    ...
    for (int i = 0; i < SAMPLES; i++) {
        // TODO: bring the target cache line into L1
    ...
    for (int i = 0; i < SAMPLES; i++) {
        // TODO: flush the target cache line
    ...
    for (int i = 0; i < SAMPLES; i++) {
        ...
        // TODO: evict the target cache line to L2
    ...
    for (int i = 0; i < SAMPLES; i++) {
        ...
        // TODO: evict the target cache line into L3
